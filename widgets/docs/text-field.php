...
// Adds widget: Widget Textfield Title
class Widgettextfieldtitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgettextfieldtitle_widget',
			esc_html__( 'Widget Textfield Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget Text field description', 'gcotheme' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<p>'.$instance['text_field_id'].'</p>';
...
function register_widgettextfieldtitle_widget() {
	register_widget( 'Widgettextfieldtitle_Widget' );
}
add_action( 'widgets_init', 'register_widgettextfieldtitle_widget' );