<?php /**
 * Password field widget template.
 *
 * Description.
 *
 * @since 1.0.0
 */
 ...
 // Adds widget: Widget Password Title
class Widgetpasswordtitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgetpasswordtitle_widget',
			esc_html__( 'Widget Password Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget password description', 'gcotheme' ), ) // Args
		);
	}
...
function register_widgetpasswordtitle_widget() {
	register_widget( 'Widgetpasswordtitle_Widget' );
}
add_action( 'widgets_init', 'register_widgetpasswordtitle_widget' );