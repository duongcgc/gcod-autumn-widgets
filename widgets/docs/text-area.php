 ...
 */
 ...
 // Adds widget: Widget Textarea Title
class Widgettextareatitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgettextareatitle_widget',
			esc_html__( 'Widget Textarea Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget Text area description', 'gcotheme' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo '<p>'.$instance['text_area_id'].'</p>';
...
function register_widgettextareatitle_widget() {
	register_widget( 'Widgettextareatitle_Widget' );
}
add_action( 'widgets_init', 'register_widgettextareatitle_widget' );