 ...
 */
 ...
 // Adds widget: Widget Email Title
class Widgetemailtitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgetemailtitle_widget',
			esc_html__( 'Widget Email Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget email description', 'gcotheme' ), ) // Args
		);
	}
...
function register_widgetemailtitle_widget() {
	register_widget( 'Widgetemailtitle_Widget' );
}
add_action( 'widgets_init', 'register_widgetemailtitle_widget' );