 ...
 */
 ...
 // Adds widget: Widget Tel Title
class Widgetteltitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgetteltitle_widget',
			esc_html__( 'Widget Tel Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget tel description', 'gcotheme' ), ) // Args
		);
	}
...
function register_widgetteltitle_widget() {
	register_widget( 'Widgetteltitle_Widget' );
}
add_action( 'widgets_init', 'register_widgetteltitle_widget' );