...
// Adds widget: Widget Media Title
class Widgetmediatitle_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'widgetmediatitle_widget',
			esc_html__( 'Widget Media Title', 'gcotheme' ),
			array( 'description' => esc_html__( 'Widget media description', 'gcotheme' ), ) // Args
		);
...
function register_widgetmediatitle_widget() {
	register_widget( 'Widgetmediatitle_Widget' );
}
add_action( 'widgets_init', 'register_widgetmediatitle_widget' );